...
const TravelStoryCard=({imgUrl,
  ...
  return (
    <div className='border rounded-lg overflow-hidden bg-white transition-all ease-in-out relative cursor-pointer hover:shadow-slate-200 hover:shadow-lg'>
      <img
      src={imgUrl} alt={title}
      className='w-full h-56 object-cover rounded-lg' onClick={onClick} />
